            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                @if (Route::has('login'))
                    <li class="top-right links" style="display: flex">
                        @auth
                            <div class="nav-item"><a class="nav-link active" href="">Xin chào! {{ Auth::user()->name }}.</a></div>
                            ...
                            @endphp
                            @if($user->isAdmin == 1)
                                <div class="nav-item ml-3"><a class="nav-link active btn btn-success"
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <div class="nav-item"><a class="nav-link active" aria-current="page"
